...
class PossibleFollowUpPatientsView(customtkinter.CTk):
    def __init__(self, parent_frame, user_id):
    # Titolo
        title = customtkinter.CTkLabel(parent_frame, text="Possible Follow Up patients", font=("Arial", 20, "bold"), text_color="black")
